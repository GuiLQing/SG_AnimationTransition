...
@implementation UIViewController (SG_AnimationTransition)

- (void)setAnimationTransitionDelegate:(SG_AnimationInteractiveTransition *)animationTransitionDelegate{
    objc_setAssociatedObject(self, InteractiveTransitionKey, animationTransitionDelegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (SG_AnimationInteractiveTransition *)animationTransitionDelegate{
...
- (void)newViewWillAppear:(BOOL)animated{
    if (self.navigationController.delegate == nil || [self.navigationController.delegate isKindOfClass:[SG_AnimationInteractiveTransition class]]) {
...
- (void)smooth_presentViewController:(UIViewController *)viewController{
    self.animationTransitionDelegate = [[SG_AnimationInteractiveTransition alloc] init];
